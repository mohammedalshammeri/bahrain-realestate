  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Section title={t('legal.introTitle')} body={t('legal.privacyIntro')} />
        <Section title={t('legal.dataCollectedTitle')} body={t('legal.dataCollectedBody')} />
        <Section title={t('legal.dataUsageTitle')} body={t('legal.dataUsageBody')} />
        <Section title={t('legal.dataSharingTitle')} body={t('legal.dataSharingBody')} />
        <Section title={t('legal.userRightsTitle')} body={t('legal.userRightsBody')} />
        <Section title={t('legal.retentionTitle')} body={t('legal.retentionBody')} />
        <Section title={t('legal.accountDeletionTitle')} body={t('legal.accountDeletionBody')} />
