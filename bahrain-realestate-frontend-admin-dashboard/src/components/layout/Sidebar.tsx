...
export default function Sidebar({ isCollapsed, onToggleAction }: SidebarProps) {
  ...
  const menuItems = [
    ...
    {
      id: 'withdrawals',
      label: t('navigation.withdrawals'),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    {      id: 'subscription-requests',
      label: t('navigation.subscriptionRequests'),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  return (
    <aside 
      className={`
        fixed start-0 top-0 z-40 h-screen bg-white dark:bg-gray-800 border-e border-gray-200 dark:border-gray-700 transition-all duration-300 ease-in-out flex flex-col
    ...
    >
        ...
        {!isCollapsed && (
          <Link href="/dashboard" className="flex items-center space-x-2 rtl:space-x-reverse">
            <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-sm">{t('common.appShortName')}</span>
            </div>
      ...
      {/* Navigation Menu */}
      <nav className="mt-4 px-2 flex-grow overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-700">
              ...
              <li key={item.id}>
                <Link
                  ...
                  className={`
                    ...
                    ${isActive 
                      ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 border-e-2 border-blue-700 dark:border-blue-400' 
        ...
        <div className="space-y-2">
            ...
            {/* Theme Toggle */}
             <button
              onClick={toggleTheme}
              className={`
                flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors duration-200 w-full
                text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white
                ${isCollapsed ? 'justify-center' : ''}
              `}
              title="Toggle Theme"
            ...
            <div className="hidden lg:block">
                ...
                >
                <span className={`${isCollapsed ? '' : 'me-3'}`}>
                    <svg className={`w-5 h-5 ${!isCollapsed ? 'rtl:rotate-180' : 'rtl:rotate-0 transform rotate-180'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
